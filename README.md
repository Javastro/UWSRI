...
This project creates a generic UWS server 
...
> [!IMPORTANT]
> it is expected that [ivoacore](https://github.com/Javastro/ivoacore) be checked out in a sibling directory whilst the APIs to ivoacore are still in flux and the packages are not published. In addition your should have checked out
